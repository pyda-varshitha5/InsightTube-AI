      ...
      <div className="relative z-20 mx-auto flex h-full max-w-7xl items-center justify-center px-6">
        ...
        >
          ...
          >
            ...
            We analyze the best YouTube videos,

            remove repetitive information,

            and generate one structured AI summary

            that helps you learn faster than ever.
          ...
          >
            ...
            <button className="group flex items-center gap-3 rounded-2xl bg-gradient-to-r from-violet-600 to-purple-600 px-8 py-4 text-lg font-semibold text-white shadow-xl shadow-violet-600/30 transition duration-300 hover:-translate-y-1 hover:shadow-violet-600/50">
            ...
            <button className="group flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-8 py-4 text-lg font-semibold text-white backdrop-blur-xl transition duration-300 hover:border-violet-500 hover:bg-violet-500/10">
